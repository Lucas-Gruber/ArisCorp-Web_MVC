    ...
    public class TechnologienController : Controller
    {
        ...
        public async Task<ActionResult> Details(string technologie)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage Res = await client.GetAsync("items/technologien/" + technologie.Replace("_", "") + "?filter[status]=published&access_token=ihGAYzxCs1LWxIGBSTWbx8w3cd7oTNCobhZdmr");
