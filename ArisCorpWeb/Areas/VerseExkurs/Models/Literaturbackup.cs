...
namespace ArisCorpWeb.Models
{
    ...
    public class LiteraturRootobjectd
    {
        public LiteraturAPI[] data { get; set; }
    }

    public class LiteraturAPId
    {
    ...
    public class LiteraturReihenRootobjectd
    {
        public LiteraturReihenAPId[] data { get; set; }
    }

    public class LiteraturReihenAPId
    {
        public string status { get; set; }
        public string reihen_titel { get; set; }
        public string reihen_cover { get; set; }
