    ...
    public class StarmapController : Controller
    {
        ...
        public async Task<ActionResult> Details(string system)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage Res = await client.GetAsync("items/systeme" + "?filter[system_name]=" + system + "&filter[status]=published&access_token=ihGAYzxCs1LWxIGBSTWbx8w3cd7oTNCobhZdmr");
