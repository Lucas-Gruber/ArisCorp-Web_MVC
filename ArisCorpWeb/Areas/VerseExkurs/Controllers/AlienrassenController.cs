    ...
    public class AlienrassenController : Controller
    {
        ...
        public async Task<ActionResult> Details(string rasse)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage Res = await client.GetAsync("items/alienrassen" + "?filter[alienrassen_name]=" + rasse + "&filter[status]=published&access_token=ihGAYzxCs1LWxIGBSTWbx8w3cd7oTNCobhZdmr");
