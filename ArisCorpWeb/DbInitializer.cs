	...
	public static class DbInitializer
	{
		public static void Initialize(IApplicationBuilder app)
		{
			using (var serviceScope = app.ApplicationServices.CreateScope())
			{
				...
				if (!context.Users.Any(usr => usr.UserName == "admin@blaucraft.net"))
				{
					var user = new IdentityUser()
					{
						UserName = "admin@blaucraft.net",
						Email = "admin@blaucraft.net",
						EmailConfirmed = true,
					};

					var userResult = _userManager.CreateAsync(user, "cmdaplag3").Result;
				}
